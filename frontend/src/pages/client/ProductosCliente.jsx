                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {productosFiltrados.map((producto) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Imagen del producto */}
                                    <div className="h-48 bg-linear-to-br from-brand-100 to-brand-200 flex items-center justify-center relative overflow-hidden">
                                        {producto.imagen_url ? (
                                            <img 
                ...
                <div className="fixed inset-0 bg-linear-to-br from-orange-50/80 via-white/80 to-yellow-50/80 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={cerrarDetalleProducto}>
                    <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="p-6">
                            ...
                            {/* Imagen del producto */}
                            <div className="h-64 bg-linear-to-br from-brand-100 to-brand-200 rounded-xl flex items-center justify-center mb-6 overflow-hidden">
